...
let execute startingPoint code =
    let {Value.context={Value.nullProto;trueProto;floatProto;stringProto;atomProto;objectProto}}
        = startingPoint in
    ...
    *)
        ...
        in match token.Token.contents with
            ...
            | Token.Group group ->
                match group.Token.closure with
                    ...
                    | Token.NonClosure ->
                        let newScope = (groupScope startingPoint.Value.context group.Token.kind frame.Value.scope) in
    ...
    and apply stack this a b =
        ...
        in match a with
            ...
            | Value.Null ->          apply stack a nullProto b
            | Value.True ->          apply stack a trueProto b
            | Value.FloatValue v ->  apply stack a floatProto b
            | Value.StringValue v -> apply stack a stringProto b
            | Value.AtomValue v ->   apply stack a atomProto b
    ...
    in let initialFrame = executeNext startingPoint.Value.rootScope [[code]] code.Token.at
